...
const BalanceWidget: FC<IBalanceWidget> = ({ selectedAccount }) => {
  ...
  return (
    <div className="w-full max-w-full md:max-w-[300px] h-full flex items-center flex-col flex-1 p-2 bg-white /*rounded-md shadow-[rgba(13,_38,_76,_0.19)_0px_9px_20px]*/">
      ...
      <Chart height="175px" width="300px" options={widgetData.options} series={widgetData.series} type="area" />
    </div>
  );
};
