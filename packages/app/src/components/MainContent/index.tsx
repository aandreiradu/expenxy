...
const MainContent = ({ children }: PropsWithChildren) => {
  ...
  return (
    <div className="flex flex-col rounded-md mt-[7rem] mb-10 w-screen h-screen md:max-h-[800px] bg-red py-[40px] px-[60px] bg-gradient-to-t from-[#e6e9f0] to-[#eef1f5 sm:ml-0 md:ml-[175px]">
